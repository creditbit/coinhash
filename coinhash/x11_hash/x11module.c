...
PyMODINIT_FUNC PyInit_x11_hash(void) {
    return PyModule_Create(&DarkcoinModule);
}

#else

PyMODINIT_FUNC initx11_hash(void) {
    (void) Py_InitModule("x11_hash", DarkcoinMethods);
}
#endif
